...
\title{
\raggedright
  \tiny\textcolor{white}{.}\Large{\color{ecocloud-blue}Language and Compiler Support for} \\[-7mm]
  \Huge{\color{ecocloud-blue}Data-Centric Optimizations} \\ [3mm]
  \footnotesize\textcolor{white}{.}\large{Vlad Ureche, EPFL <vlad.ureche@epfl.ch>}
  \vspace{-28mm}
}
