...
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\pagewidth]{}};
    %\draw [fill=white, line=none] (79,114) rectangle (90,120);
    \fill[white] (74.9,110) rectangle (85,119);
    \node(qr) at (78.4,111.5) {\includegraphics[scale=0.23]{ldl-frog.pdf}};
...
\title{
  \vspace{-3mm}\LARGE{\textbf{Automating Ad hoc Data Representation Transformations}\bkpspace}\vspace{-2mm}
}
\author{
